...
function brandLockup(compact=false) {
  return `<div class="brandLockup ${compact?'compact':''}"><span class="kixelPlate"><img class="kixelLogo" src="./kixel-logo.png?v=uploaded-logos1" alt="KIXEL"></span><span class="bornAt">BORN AT <img src="./lvfc-logo.png?v=uploaded-logos1" alt="LVFC"></span></div>`;
}
