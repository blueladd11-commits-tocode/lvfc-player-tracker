import './kixel-app-v4.js?v=mobile-recovery-3';
  ...
  return `
    <div class="clubBrand ${compact ? 'compact' : ''}">
      <span class="lvfcPrimary">
        <img src="./lvfc-logo.png?v=mobile-recovery-3" alt="Lahore Virgil Football Club">
        <small>PLAYER DEVELOPMENT</small>
      </span>
      <span class="poweredBy">
        <small>POWERED BY</small>
        <img src="./kixel-logo.png?v=mobile-recovery-3" alt="KIXEL">
      </span>
    </div>`;
}
