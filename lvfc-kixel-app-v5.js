import './kixel-app-v4.js?v=lvfc-kixel6';
  ...
  return `
    <div class="clubBrand ${compact ? 'compact' : ''}">
      <span class="lvfcPrimary">
        <img src="./lvfc-logo-white.svg?v=lvfc-kixel6" alt="Lahore Virgil Football Club">
        <small>PLAYER DEVELOPMENT</small>
      </span>
      <span class="poweredBy">
        <small>POWERED BY</small>
        <img src="./kixel-logo.svg?v=lvfc-kixel6" alt="KIXEL">
      </span>
    </div>`;
}
